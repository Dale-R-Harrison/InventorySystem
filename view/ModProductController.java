...
public class ModProductController implements Initializable {
    ...
    public void setTextBoxes (int id, String name, int stock, double price, int max, int min) {
        productId.setText(String.valueOf(id));
        productName.setText(name);
        productInv.setText(String.valueOf(stock));
        productPrice.setText(String.valueOf(price));
        productMax.setText(String.valueOf(max));
        productMin.setText(String.valueOf(min));
    }
    ...
    public void saveBttnPushed(ActionEvent event) throws IOException, MinMaxException {
        try {
            try {
                ...
                int id = parseInt(productId.getText());
                ...
                controller.inv.updateProduct(indexToMod, productToAdd);
